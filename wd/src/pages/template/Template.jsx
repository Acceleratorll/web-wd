        ...
        <>
            <header className="h-screen bg-fixed bg-center bg-cover custom-img mb-10">
                ...
                <div className="flex h-screen">
                    <div className="m-auto">
                        <p className="text-xl text-gray-800 font-rale-way lg:text-3xl sm:text-xl font-bold sm:px-16 dark:text-gray-400">We Are Getting Married</p>
                        <p className="leading-7 my-28 font-great-vibes lg:text-9xl text-7xl tracking-tight text-gray-900 dark:text-white ">Romeo & Juliet</p>
                        <p className="font-normal text-gray-500 text-xl sm:px-16 dark:text-gray-400 font-alegreya">Kepada Yth</p>
                        <p className="font-normal text-gray-500 text-xl sm:px-16 dark:text-gray-400 font-alegreya">Bapak/Ibu/Saudara/i</p>
                        <p className="font-bold text-slate-800 text-2xl sm:px-16 dark:text-gray-400 font-alegreya mt-10">Wisnu Yuwono</p>
                    </div>
                </div>
            </header>
            ...
            <section id="bottom-navigation" className="block fixed inset-x-0 bottom-0 z-10 bg-white shadow">
                <div id="tabs" className="flex justify-between">
                    <a href="#home" className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
                    ...
                    <a href="#couple" className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
                        <svg width="25" height="25" viewBox="0 0 42 42" className="inline-block mb-1">
                            <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                        ...
                        <span className="tab tab-kategori block text-xs">Couple</span>
                    </a>
                    <a href="#Events" className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
                        <svg width="25" height="25" viewBox="0 0 42 42" className="inline-block mb-1">
                            <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                        ...
                        <span className="tab tab-explore block text-xs">Events</span>
                    </a>
                    <a href="#Gallery" className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
                        <svg width="25" height="25" viewBox="0 0 42 42" className="inline-block mb-1">
                            <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                <path d="M14.7118754,20.0876892 L8.03575361,20.0876892 C5.82661462,20.0876892 4.03575361,18.2968282 4.03575361,16.0876892 L4.03575361,12.031922 C4.03575361,8.1480343 6.79157254,4.90780265 10.4544842,4.15995321 C8.87553278,8.5612583 8.1226025,14.3600511 10.9452499,15.5413938 C13.710306,16.6986332 14.5947501,18.3118357 14.7118754,20.0876892 Z M14.2420017,23.8186831 C13.515543,27.1052019 12.7414284,30.2811559 18.0438552,31.7330419 L18.0438552,33.4450645 C18.0438552,35.6542035 16.2529942,37.4450645 14.0438552,37.4450645 L9.90612103,37.4450645 C6.14196811,37.4450645 3.09051926,34.3936157 3.09051926,30.6294627 L3.09051926,27.813861 C3.09051926,25.604722 4.88138026,23.813861 7.09051926,23.813861 L14.0438552,23.813861 C14.1102948,23.813861 14.1763561,23.8154808 14.2420017,23.8186831 Z M20.7553776,32.160536 C23.9336213,32.1190063 23.9061943,29.4103976 33.8698747,31.1666916 C34.7935223,31.3295026 35.9925894,31.0627305 37.3154077,30.4407183 C37.09778,34.8980343 33.4149547,38.4450645 28.9036761,38.4450645 C24.9909035,38.4450645 21.701346,35.7767637 20.7553776,32.160536 Z" fill="currentColor" opacity="0.1"></path>
                                <g transform="translate(2.000000, 3.000000)">
                        ...
                        <span className="tab tab-whishlist block text-xs">Gallery</span>
                    </a>
                    <a href="#Guest Book" className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
                        <svg width="25" height="25" viewBox="0 0 42 42" className="inline-block mb-1">
                            <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                <path d="M14.7118754,20.0876892 L8.03575361,20.0876892 C5.82661462,20.0876892 4.03575361,18.2968282 4.03575361,16.0876892 L4.03575361,12.031922 C4.03575361,8.1480343 6.79157254,4.90780265 10.4544842,4.15995321 C8.87553278,8.5612583 8.1226025,14.3600511 10.9452499,15.5413938 C13.710306,16.6986332 14.5947501,18.3118357 14.7118754,20.0876892 Z M14.2420017,23.8186831 C13.515543,27.1052019 12.7414284,30.2811559 18.0438552,31.7330419 L18.0438552,33.4450645 C18.0438552,35.6542035 16.2529942,37.4450645 14.0438552,37.4450645 L9.90612103,37.4450645 C6.14196811,37.4450645 3.09051926,34.3936157 3.09051926,30.6294627 L3.09051926,27.813861 C3.09051926,25.604722 4.88138026,23.813861 7.09051926,23.813861 L14.0438552,23.813861 C14.1102948,23.813861 14.1763561,23.8154808 14.2420017,23.8186831 Z M20.7553776,32.160536 C23.9336213,32.1190063 23.9061943,29.4103976 33.8698747,31.1666916 C34.7935223,31.3295026 35.9925894,31.0627305 37.3154077,30.4407183 C37.09778,34.8980343 33.4149547,38.4450645 28.9036761,38.4450645 C24.9909035,38.4450645 21.701346,35.7767637 20.7553776,32.160536 Z" fill="currentColor" opacity="0.1"></path>
                                <g transform="translate(2.000000, 3.000000)">
                        ...
                        <span className="tab tab-account block text-xs">Guest Book</span>
                    </a>
                </div>
            </section>

            <div className="my-10">
                <p className='text-black font-great-vibes text-5xl pb-14'>Pasangan Pengantin</p>
                <div className="max-w-screen-lg mx-auto grid grid-cols-1 lg:grid-cols-2 sm:grid-cols-2 gap-4">
                    <div className="flex justify-center items-center">
                        <div className="container flex justify-center">
                            <div className="max-w-sm">
                                <div className="bg-white relative shadow-lg hover:shadow-xl transition duration-500 rounded-lg">
                                    <img className="rounded-t-lg" src="https://demo.templateflip.com/wonderful-wedding/images/groom.jpg" alt="" />
                                    <div className="py-6 px-8 rounded-lg bg-white">
                                        <p className="text-gray-700 tracking-wide text-justify">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eum, labore. Ea debitis beatae sequi deleniti.</p>
                                        <p className="text-gray-700 font-bold font-tangerine text-5xl mb-3 hover:text-gray-900 hover:cursor-pointer mt-5">Romeo</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex justify-center items-center">
                        <div className="container flex justify-center">
                            <div className="max-w-sm">
                                <div className="bg-white relative shadow-lg hover:shadow-xl transition duration-500 rounded-lg">
                                    <img className="rounded-t-lg" src="https://demo.templateflip.com/wonderful-wedding/images/bride.jpg" alt="" />
                                    <div className="py-6 px-8 rounded-lg bg-white">
                                        <p className="text-gray-700 tracking-wide text-justify">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eum, labore. Ea debitis beatae sequi deleniti.</p>
                                        <p className="text-gray-700 font-bold font-tangerine text-5xl mb-3 hover:text-gray-900 hover:cursor-pointer mt-5">Juliet</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div className="my-10">
                <p className='text-black font-great-vibes text-5xl lg:pb-14'>Wedding Events</p>
                <div className="max-w-screen-2xl mx-auto sm:mb-10 lg:grid lg:grid-cols-5 md:grid-cols-none bg-white lg:h-full">
                    <div className=" px-10 max-w-md m-auto lg:col-span-2 mt-10 mb-20 shadow-xl rounded-xl lg:mt-10 md:shadow-xl md:rounded-xl lg:shadow-none lg:rounded-none lg:w-full lg:mb-10 lg:px-5 lg:pt-5 lg:pb-5 lg:max-w-lg bg-white">
                        <div className="py-10">
                            <p className="my-7 font-bold lg:mt-7 text-3xl text-left">Wedding Party</p>
                            <div className="flex mb-4">
                                <img className='w-7 mr-2' src="https://cdn-icons-png.flaticon.com/512/684/684908.png" alt="" />
                                <p className="font-bold text-lg text-gray-800 text-left">Church End, Hendon, London, UK</p>
                            </div>
                            <div className="flex">
                                <img className='w-7 mr-2' src="https://cdn-icons-png.flaticon.com/512/2886/2886665.png" alt="" />
                                <p className="font-bold text-lg text-gray-800 text-left">20 Dec 2018, 9AM - 6PM</p>
                            </div>
                            <p className="text-lg text-black text-justify pt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        </div>
                    </div>

                    <div className="hidden relative lg:block  lg:col-span-3">
                        <img className="absolute inset-0 w-full h-full object-cover object-center" src="https://demo.templateflip.com/wonderful-wedding/images/wedding-party.jpg" alt="Ad- woman on a beach" />
                    </div>
                </div>
            </div>

            <section className="overflow-hidden text-gray-700">
                <div className="container px-5 mx-auto lg:px-32 my-10">
                    <p className='text-black font-great-vibes text-5xl pb-14'>Gallery</p>
            ...
            <div className="my-10">
                <p className='text-black font-great-vibes text-5xl my-8'>Guest Book</p>
                    ...
                    <div className="mx-auto w-full max-w-[550px] bg-white">
                        ...
                        >
                            <div className="mb-5">
                                <label
                                    htmlFor="email"
                                    className="mb-3 block text-base text-left font-medium text-[#07074D]"
                                >
                                    Nama
                                </label>
                                <input
                            ...
                            <div className="">
                                ...
                                <textarea
                                    ...
                                    className="w-full mb-6 resize-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                ></textarea>
                            </div>
            ...
            {/* <section
                class="block fixed bottom-0 inset-x-0 z-50 shadow-lg text-gray-800 bg-blue-500 dark:bg-dark backdrop-blur-lg dark:bg-opacity-30 dark:text-gray-400">
                <div id="tabs" class="flex justify-between">
                    ...
                    <a href="a"
                        ...
                        <span class="tab block text-xs">Story</span>
                    </a>
                    <a href="a"
                        class="w-full focus:text-royal hover:text-royal justify-center inline-block text-center pt-2 pb-1 hover:bg-white"
                        activeClass="dark:text-gray-100 text-black">
                        ...
                        <span class="tab block text-xs">Event</span>
                    </a>
                    <a href="a"
                        class="w-full focus:text-royal hover:text-royal justify-center inline-block text-center pt-2 pb-1 hover:bg-white"
                        activeClass="dark:text-gray-100 text-black">
