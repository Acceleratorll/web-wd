...
const PegawaiKelurahan = () => {
    ...
    const onSaveEdit = async () => {
        ...
        await axios.put(`/pegawai/${pegawaiKelurahan?.nik}`, dataSaveEdit, {
            headers: {
        ...
        mutate(`/admin/pegawai-kelurahan`)
    }
    ...
    const onSaveAdd = async () => {
        ...
        await axios.post(`/pegawai/`, dataSave, {
            headers: {
                Authorization: "Bearer " + localStorage.getItem("xtoken"),
            },
        }).then(result => {
                                        ...
                                        <tbody className="bg-white">
                                            {
                                                !pegawaiKelurahans ? (
                                                    ...
                                                    <tr key={i}>
                                                        ...
                                                        <td className="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                                                            {element?.photo.length > 0 ? <img width={100} height={100} src={element?.photo} alt={element?.nama} /> : <img width={50} height={50} alt={element?.nama} />}
                                                        </td>
