...
const Toast = () => {
    return (
        <div id="toast-interactive" class="mx-auto p-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-400" role="alert">
            <div class="flex">
                ...
                <div class="ml-3 text-sm font-normal">
                    <span class="mb-1 text-sm font-semibold text-gray-900 dark:text-white">Tips Profesional
                        Overall</span>
                    <div class="mb-2 text-sm font-normal">Cantumkan informasi yang benar dan terbaru.</div>
                </div>
